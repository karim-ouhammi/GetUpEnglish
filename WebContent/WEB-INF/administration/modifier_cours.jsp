    ...
    <main>
        ...
        <div class="chemin">
            <ul class="chemin_ul">
                ...
                /
                <li class="chemin_li">Modifier Cours</li>
            </ul>
        </div>
        ...
        <div class="ins-log">
            <div class="titre">
                <h1>Modifier Cours :  ${ cours.titre }</h1>
            </div>
            
            <div class="form">
                <form action="<c:url value="adminModificationCours"/>" method="post">
                    
                    <!-- hidden id field -->
                    <input type="hidden" id="id" name="id" value="<c:out value="${ cours.id }"/>">
                    <!-- /.hidden id field -->
                    ...
                    <div class="input_div">
                        <input type="submit" name="modifier" class="input" value="Modifier">
                    </div>
                </form>
            </div>
        </div>
